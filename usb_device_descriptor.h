...
#define USB_AUDIO_STREAM_IN_ENDPOINT_COUNT  (1U)
#define USB_AUDIO_STREAM_OUT_ENDPOINT_COUNT (2U)
#define USB_AUDIO_CONTROL_ENDPOINT_COUNT    (1U)

#define USB_AUDIO_STREAM_IN_ENDPOINT           (2U)
#define USB_AUDIO_STREAM_OUT_ENDPOINT          (1U)
#define USB_AUDIO_STREAM_OUT_FEEDBACK_ENDPOINT (1U)
...
#define HS_ISO_OUT_FEEDBACK_ENDP_PACKET_SIZE (4U)
#define FS_ISO_OUT_FEEDBACK_ENDP_PACKET_SIZE (4U)
...
#define FS_ISO_OUT_FEEDBACK_ENDP_INTERVAL (0x01U)
#define HS_ISO_OUT_FEEDBACK_ENDP_INTERVAL (0x04U)
...
#define USB_AUDIO_IN_CONTROL_CLOCK_SOURCE_ENTITY_ID  (0x06U)
#define USB_AUDIO_OUT_CONTROL_CLOCK_SOURCE_ENTITY_ID (0x5U)

#define USB_AUDIO_IN_CONTROL_INPUT_TERMINAL_ID  (0x02U)
#define USB_AUDIO_OUT_CONTROL_INPUT_TERMINAL_ID (0x01U)

#define USB_AUDIO_IN_CONTROL_OUTPUT_TERMINAL_ID  (0x04U)
#define USB_AUDIO_OUT_CONTROL_OUTPUT_TERMINAL_ID (0x03U)
