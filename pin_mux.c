...
- {pin_num: C11, pin_signal: PIO0_30/FC4_RXD_SDA_MOSI_DATA/CTIMER4_MAT2/I2S_BRIDGE_DATA_OUT/SEC_PIO0_30, label: I2S_SDOUT, identifier: I2S_SDOUT}
...
- pin_list:
  ...
  - {pin_num: G16, peripheral: FLEXCOMM5, signal: SCK, pin_signal: PIO1_3/FC5_SCK, identifier: I2S_CLK, direction: INPUT, ibena: enabled, drive: normal}
